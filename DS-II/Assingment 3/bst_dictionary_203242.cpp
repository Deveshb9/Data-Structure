...
mtech@MTECHCSE:~$ cd Desktop
mtech@MTECHCSE:~/Desktop$ g++ bst_dictionary_203242.cpp
mtech@MTECHCSE:~/Desktop$ ./a.out
...
Enter the root keyword & meaning:
mendicant
a pauper who lives begging

Do you want to Add more elements to Binary tree (y/n): y
...
Enter the keyword & meaning:
vapid
lacking significance or spirit or zest
...
Enter the keyword & meaning:
blase
nonchanlantly unconcerned

Do you want to Add more elements to Binary tree (y/n): y

Enter the keyword & meaning:
odium
hate coupled with digest

Do you want to Add more elements to Binary tree (y/n): n


Preordered BST is  :

mendicant => a pauper who lives begging
blase => nonchanlantly unconcerned
vitiate => make imperfect
vapid => lacking significance or spirit or zest
ruddy => inclined to a healthy reddish color
odium => hate coupled with digest
